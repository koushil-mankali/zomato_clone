...
import ZomatoLogo from '../../../public/images/zomato3.jpg';
import Gstore from '../../../public/images/playstore.png';
    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}><img className={footerCss.logo} src={ZomatoLogo} alt="logo" /></div>
